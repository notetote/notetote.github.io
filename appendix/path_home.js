...
<content class="flex flex-column">
  ...
  <footer class="flex flex-row flex-space-between container font-light">
    <span>
      <a href="https://notenibba.github.io/">
        <i class="fa fa-notenibba margin m0 right"></i>NoteNibba </a> | <a href="https://www.gnu.org/licenses/gpl-3.0-standalone.html">GPL-3.0</a>
    </span>
