...
document.querySelector("main").innerHTML = loadingIcon + '<span class="flex flex-row flex-center-h flex-center-v"><span class="dots">.</span><span>updating database</span><span class="dots">.</span></span>';
